...
| Field | Type | Description |
|---|---|---|
| `clusterName` | `string` | Value of the `cluster` external label applied to all metrics and logs. Identifies this cluster when several feed one Grafana or Thanos. |
